...
import com.example.wordle.Dialog.LostDialog;
import com.example.wordle.Dialog.PassDialog;
...
public enum GameMode implements GameItem {
	STEP_MODE() {
		...
		public void onFinished(WordleGame wordleGame) {
			...
			String c = Level.getRandomWord(wordleGame);
	...
	public abstract int getBackgroundInt();

	public Drawable getBackground(Context c) {
		return AppCompatResources.getDrawable(c, getBackgroundInt());
	}
}
